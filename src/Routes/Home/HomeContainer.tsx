...
class HomeContainer extends React.Component<IProps, IState> {
	...
	public createPath = () => {
		...
		const directionsService: google.maps.DirectionsService = new google.maps
			.DirectionsService();
				...
				for (const driver of drivers) {
					if (driver && driver.lastLat && driver.lastLng) {
						...
						if (exisitingDriver) {
							...
							const newMarker: google.maps.Marker = new google
								.maps.Marker(markerOptions);
